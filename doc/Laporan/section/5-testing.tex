...
\subsection{Kasus Uji Objek \textit{cow}}\label{sub:kasus_uji_cow} % (fold)

\begin{itemize}
    \item Input :
        \begin{center}
            \includegraphics[width=0.5\textwidth]{figures/cow-input.png}
            \captionof{figure}{Input Kasus Uji \textit{cow}}
        \end{center}
    \item Output:
        \begin{enumerate}
            \item \texttt{maxDepth} = 3 \\
                \begin{center}
                    ...
                    \captionof{figure}{Hasil Kasus Uji \textit{cow} dengan \texttt{maxDepth} = 3}
                \end{center}
            \item \texttt{maxDepth} = 5 \\
                \begin{center}
                    \includegraphics[width=0.3\textwidth]{figures/cow-output-5.png}
                    \captionof{figure}{Hasil Kasus Uji \textit{cow} dengan \texttt{maxDepth} = 5}
                \end{center}
            \item \texttt{maxDepth} = 7 \\
                \begin{center}
                    \includegraphics[width=0.3\textwidth]{figures/cow-output-7.png}
                    \captionof{figure}{Hasil Kasus Uji \textit{cow} dengan \texttt{maxDepth} = 7}
                \end{center}
        \end{enumerate}
\end{itemize}

\subsection{Kasus Uji Objek \textit{teapot}}\label{sub:kasus_uji_teapot} % (fold)
\begin{itemize}
    \item Input :
        \begin{center}
            \includegraphics[width=0.5\textwidth]{figures/teapot-input.png}
            \captionof{figure}{Input Kasus Uji \textit{teapot}}
        \end{center}
    \item Output:
        \begin{enumerate}
            \item \texttt{maxDepth} = 3 \\
                \begin{center}
                    ...
                    \captionof{figure}{Hasil Kasus Uji \textit{teapot} dengan \texttt{maxDepth} = 3}
                \end{center}
            \item \texttt{maxDepth} = 5 \\
                \begin{center}
                    \includegraphics[width=0.3\textwidth]{figures/teapot-output-5.png}
                    \captionof{figure}{Hasil Kasus Uji \textit{teapot} dengan \texttt{maxDepth} = 5}
                \end{center}
            \item \texttt{maxDepth} = 7 \\
                \begin{center}
                    \includegraphics[width=0.3\textwidth]{figures/teapot-output-7.png}
                    \captionof{figure}{Hasil Kasus Uji \textit{teapot} dengan \texttt{maxDepth} = 7}
                \end{center}
        \end{enumerate}
\end{itemize}

\subsection{Hasil Pengujian}\label{sub:hasil_pengujian} % (fold)
